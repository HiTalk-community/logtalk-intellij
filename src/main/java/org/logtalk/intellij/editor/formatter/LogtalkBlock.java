...
import static com.intellij.formatting.Alignment.createAlignment;
 ...
 */
public
class LogtalkBlock implements Block {
     ...
     */
    public
    SpacingBuilder getSpaceBuilder () {
        return spaceBuilder;
    }

    /**
     * org.logtalk.intellij.editor.formatter;
     */
     ...
     */
    public
    LogtalkBlock ( ASTNode node, Wrap wrap, Alignment alignment, SpacingBuilder spaceBuilder ) {
        this.node = node;
        this.wrap = wrap;
     ...
     * If immutable list is returned (e.g. {@code Collections.singletonList(xxx)}, you must mark this {@link Block}
     *
    ...
    public
    Wrap getWrap () {
        return Wrap.createWrap(WRAP_AS_NEEDED, true);
    }
