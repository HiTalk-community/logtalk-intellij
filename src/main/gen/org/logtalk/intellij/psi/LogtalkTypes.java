...
public interface LogtalkTypes {
  ...
  IElementType PROPERTY = new LogtalkElementType("PROPERTY");
  ...
  IElementType KEY = new LogtalkTokenType("KEY");
  ...
  IElementType SEPARATOR = new LogtalkTokenType("SEPARATOR");
  ...
  IElementType VALUE = new LogtalkTokenType("VALUE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ATOM) {
        ...
        return new LogtalkPropertyImpl(node );
      }
